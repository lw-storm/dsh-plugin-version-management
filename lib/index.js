 ...
 *
 * Safety:
 * - every restore validates the snapshot structure before touching anything;
 * - a timestamped backup of package.json is written before any modification;
 * - concurrent restore attempts are rejected (one at a time via restoreState).
 */
...
const SNAPSHOT_FORMAT = 'dsh-plugin-snapshot'
